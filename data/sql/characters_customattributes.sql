...
CREATE TABLE "characters_customattributes" (
  ...
  "strSpent" integer DEFAULT '0',
  "vitSpent" integer DEFAULT '0',
  "dexSpent" integer DEFAULT '0',
  "intSpent" integer DEFAULT '0',
  "minSpent" integer DEFAULT '0',
  "pieSpent" integer DEFAULT '0',
