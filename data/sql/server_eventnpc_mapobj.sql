...
DROP TABLE IF EXISTS "server_eventnpc_mapobj" CASCADE;
CREATE TABLE "server_eventnpc_mapobj" (
  "id" bigint NOT NULL,
...
INSERT INTO "server_eventnpc_mapobj" ("id", "layoutId", "instanceId") VALUES
	(589, 321, 3294),
	(590, 391, 2),
	(624, 321, 2948),
	(623, 321, 2947),
