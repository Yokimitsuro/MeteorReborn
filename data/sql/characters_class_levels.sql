...
CREATE TABLE "characters_class_levels" (
  ...
  "pug" smallint DEFAULT '0',
  "gla" smallint DEFAULT '0',
  "mrd" smallint DEFAULT '0',
  "arc" smallint DEFAULT '0',
  "lnc" smallint DEFAULT '0',
  "thm" smallint DEFAULT '0',
  "cnj" smallint DEFAULT '0',
  "crp" smallint DEFAULT '0',
  "bsm" smallint DEFAULT '0',
  "arm" smallint DEFAULT '0',
  "gsm" smallint DEFAULT '0',
  "ltw" smallint DEFAULT '0',
  "wvr" smallint DEFAULT '0',
  "alc" smallint DEFAULT '0',
  "cul" smallint DEFAULT '0',
  "min" smallint DEFAULT '0',
  "btn" smallint DEFAULT '0',
  "fsh" smallint DEFAULT '0',
