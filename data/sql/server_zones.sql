...
CREATE TABLE "server_zones" (
  ...
  "isIsolated" smallint DEFAULT '0',
  "isInn" smallint DEFAULT '0',
  "canRideChocobo" smallint DEFAULT '1',
  "canStealth" smallint DEFAULT '0',
  "isInstanceRaid" smallint DEFAULT '0',
  "loadNavMesh" smallint NOT NULL,
  PRIMARY KEY ("id")
);
