// PM-COMPLETE → verbatim port de Lobby Server/Packets/Send/CharacterListPacket.cs (PM:22-179).
// LANG-ADAPT: namespace + nullable.
//
// NOTA: este archivo referencia `Database.GetAppearance(chara.id)` y `Database.GetServer(chara.serverId)`
// que aún no están portados (van en sub-item 2.4 LANG-ADAPT EF Core). Hasta entonces el build del
// proyecto Lobby fallará en este archivo. Es PM-faithful: PM tiene la misma dependencia. Se resuelve
// al portar Database.
