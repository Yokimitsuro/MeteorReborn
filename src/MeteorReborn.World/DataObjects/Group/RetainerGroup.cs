// PM-COMPLETE → verbatim port de World Server/DataObjects/Group/RetainerGroup.cs (99 líneas).
...
using Serilog;
using MeteorReborn.World.Actor.Group.Work;
using MeteorReborn.World.Packets.Send.Subpackets.Groups;

namespace MeteorReborn.World.DataObjects.Group
{
