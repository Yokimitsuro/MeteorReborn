// PM-COMPLETE → verbatim port de World Server/Packets/Receive/Subpackets/PartyChatMessagePacket.cs (52 líneas).
...
namespace MeteorReborn.World.Packets.Receive.Subpackets
{
