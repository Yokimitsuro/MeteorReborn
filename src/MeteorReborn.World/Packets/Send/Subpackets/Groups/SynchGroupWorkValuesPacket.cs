// PM-COMPLETE → verbatim port de World Server/Packets/Send/Subpackets/Groups/SynchGroupWorkValuesPacket.cs (230 líneas).
...
namespace MeteorReborn.World.Packets.Send.Subpackets.Groups
{
