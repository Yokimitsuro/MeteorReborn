// PM-COMPLETE → verbatim port de World Server/Packets/WorldPackets/Send/Group/PartySyncPacket.cs (55 líneas).
...
namespace MeteorReborn.World.Packets.WorldPackets.Send.Group
{
