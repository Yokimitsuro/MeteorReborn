...
namespace MeteorReborn.Map.DataObjects
{
    class InventoryItem
    {
        ...
        public class ItemModifier
        {
            ...
            public ItemModifier(IDataReader reader)
            {
        ...
        public InventoryItem(IDataReader reader)
        {
        ...
        public void SaveDealingInfo(NpgsqlCommand cmd)
        {
            cmd.Parameters.AddParam("@serverItemId", uniqueId);
            cmd.Parameters.AddParam("@dealingValue", dealingVal);
            cmd.Parameters.AddParam("@dealingMode", dealingMode);
            cmd.Parameters.AddParam("@dealingAttached1", dealingAttached1);
            cmd.Parameters.AddParam("@dealingAttached2", dealingAttached2);
            cmd.Parameters.AddParam("@dealingAttached3", dealingAttached3);
            cmd.Parameters.AddParam("@dealingTag", tags[0]);
            cmd.Parameters.AddParam("@bazaarMode", tagValues[0]);
        }
