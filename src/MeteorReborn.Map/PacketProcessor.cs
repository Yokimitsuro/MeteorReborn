// PM-COMPLETE → verbatim port de Map Server/PacketProcessor.cs (394 líneas).
...
using MeteorReborn.Map.Packets.Receive;
using MeteorReborn.Map.Packets.Send;
using MeteorReborn.Map.Packets.Send.Login;
using MeteorReborn.Map.Packets.Send.Actor;
using MeteorReborn.Map.Packets.Send.SupportDesk;
using MeteorReborn.Map.Packets.Receive.Social;
using MeteorReborn.Map.Packets.Send.Social;
using MeteorReborn.Map.Packets.Receive.SupportDesk;
using MeteorReborn.Map.Packets.Receive.Recruitment;
using MeteorReborn.Map.Packets.Send.Recruitment;
        ...
        {                          
                ...
                switch (subpacket.gameMessage.opcode)
                {
                    ...
                    case 0x1001:
                        ...
                        Log.Information("{0} has been removed from the session list.", session.GetActor().customDisplayName);
                    ...
                    case 0x0003:
                        ...
                        //Log.Information("Got type-{5} message: {0} @ {1}, {2}, {3}, Rot: {4}", chatMessage.message, chatMessage.posX, chatMessage.posY, chatMessage.posZ, chatMessage.posRot, chatMessage.logType);
                    ...
                    case 0x01D6:
                        ...
                        break;
                    default:
                        Log.Debug("Unknown command 0x{0:X} received.", subpacket.gameMessage.opcode);
                        subpacket.DebugPrintSubPacket();
                        break;
                }
