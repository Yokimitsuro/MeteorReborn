// PM-COMPLETE → verbatim port de Map Server/Packets/Send/Recruitment/CurrentRecruitmentDetailsPacket.cs (75 líneas).
...
namespace MeteorReborn.Map.Packets.Send.Recruitment
{
