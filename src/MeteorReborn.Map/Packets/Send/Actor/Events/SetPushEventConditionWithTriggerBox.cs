// PM-COMPLETE → verbatim port de Map Server/Packets/Send/Actor/Events/SetPushEventConditionWithTriggerBox.cs (59 líneas).
...
namespace MeteorReborn.Map.Packets.Send.Actor.Events
{
