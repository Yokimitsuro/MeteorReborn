// PM-COMPLETE → verbatim port de Map Server/Packets/Send/Actor/SetActorPropetyPacket.cs (243 líneas).
...
namespace MeteorReborn.Map.Packets.Send.Actor
{
    class SetActorPropetyPacket
    {
        ...
        public bool AddProperty(MeteorReborn.Map.Actors.Actor actor, string name)
        {
            ...
            else
            {
                ...
                uint id = MeteorReborn.Common.Utils.MurmurHash2(name, 0);
                if (curObj is bool)                
