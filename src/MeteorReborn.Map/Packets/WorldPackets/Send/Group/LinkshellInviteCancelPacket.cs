// PM-COMPLETE → verbatim port de Map Server/Packets/WorldPackets/Send/Group/LinkshellInviteCancelPacket.cs (38 líneas).
...
namespace MeteorReborn.Map.Packets.WorldPackets.Send.Group
{
