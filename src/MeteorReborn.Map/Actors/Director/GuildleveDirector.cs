// PM-COMPLETE → verbatim port de Map Server/Actors/Director/GuildleveDirector.cs (272 líneas).
...
using Serilog;
using MeteorReborn.Map.Actors.director.work;
...
namespace MeteorReborn.Map.Actors.director
{
    class GuildleveDirector : Director
    {
        ...
        public void StartGuildleve()
        {
            ...
            guildleveWork.startTime = MeteorReborn.Common.Utils.UnixTimeStampUTC();
        ...
        public void EndGuildleve(bool wasCompleted)
        {
            ...
            completionTime = MeteorReborn.Common.Utils.UnixTimeStampUTC() - guildleveWork.startTime;
