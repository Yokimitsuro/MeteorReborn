// PM-COMPLETE → verbatim port de Map Server/Actors/Chara/Ai/StatusEffect.cs (723 líneas).
...
namespace MeteorReborn.Map.Actors.Chara.Ai
{
    ...
    class StatusEffect
    {
        ...
        public void SetEndTime(DateTime time)
        {
            ...
            {
                endTime = MeteorReborn.Common.Utils.UnixTimeStampToDateTime(4294967295);
            }
            else
            {
                endTime = time;
        ...
        public void RefreshTime()
        {
            ...
            if (index >= 0)
                owner.statusEffects.SetTimeAtIndex(index, (uint) MeteorReborn.Common.Utils.UnixTimeStampUTC(endTime));
        }
