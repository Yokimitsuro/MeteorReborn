// PM-COMPLETE → verbatim port de Map Server/Actors/Chara/Ai/State/MagicState.cs (213 líneas).
            ...
            else
            {
                ...
                // command casting duration
                    if (owner is Player)
                    {
                        ...
                        ((Player)owner).SendStartCastbar(spell.id, MeteorReborn.Common.Utils.UnixTimeStampUTC(DateTime.Now.AddMilliseconds(spellSpeed)));
                    }
