// PM-COMPLETE → verbatim port de Map Server/Actors/Group/ContentGroup.cs (194 líneas).
...
using Serilog;
using MeteorReborn.Map.Actors.group.work;
using MeteorReborn.Map.Actors;
using MeteorReborn.Map.DataObjects;
using MeteorReborn.Map.Packets.Send.group;
using MeteorReborn.Map.Packets.Send.Groups;
using System.Collections.Generic;

namespace MeteorReborn.Map.Actors.group
{
    class ContentGroup : Group
    {
        ...
        public override void SendInitWorkValues(Session session)
        {
            ...
            groupWork.addByte(MeteorReborn.Common.Utils.MurmurHash2("contentGroupWork.property[0]", 0), 1);
        ...
        {
            ulong time = MeteorReborn.Common.Utils.MilisUnixTimeStampUTC();
