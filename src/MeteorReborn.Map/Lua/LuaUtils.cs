// PM-COMPLETE → verbatim port de Map Server/Lua/LuaUtils.cs (534 líneas).
    ...
    class LuaUtils
    {
        ...
        public static List<LuaParam> ReadLuaParams(BinaryReader reader)
        {
            ...
            while (true)
            {
                ...
                {
                    case 0x0: //Int32
                        value = MeteorReborn.Common.Utils.SwapEndian(reader.ReadInt32());                        
                        break;
                    case 0x1: //Int32
                        value = MeteorReborn.Common.Utils.SwapEndian(reader.ReadUInt32());        
                        break;          
                    ...
                    case 0x7: //Item Reference to Inventory Spot
                        {
                            uint type7ActorId = MeteorReborn.Common.Utils.SwapEndian(reader.ReadUInt32());
                    ...
                    case 0x8: //Used for offering
                        {
                            uint actorId = MeteorReborn.Common.Utils.SwapEndian(reader.ReadUInt32());
                            ushort rewardSlot = MeteorReborn.Common.Utils.SwapEndian(reader.ReadUInt16());
                            byte   rewardPackageId = reader.ReadByte();
                            byte   unk1 = reader.ReadByte(); //Always 0x2?
                            ushort seekSlot = MeteorReborn.Common.Utils.SwapEndian(reader.ReadUInt16());
                    ...
                    case 0x9: //Two Longs (only storing first one)
                        value = new Type9Param(MeteorReborn.Common.Utils.SwapEndian(reader.ReadUInt64()), MeteorReborn.Common.Utils.SwapEndian(reader.ReadUInt64()));
                        break;
                    case 0xC: //Byte
        ...
        public static void WriteLuaParams(BinaryWriter writer, List<LuaParam> luaParams)
        {
            if (luaParams == null)
            {
                Log.Error("LuaUtils.WriteLuaParams LuaParams are null!");
                return;
            }
            ...
            {           
                ...
                {
                    case 0x0: //Int32                        
                        writer.Write((Int32)MeteorReborn.Common.Utils.SwapEndian((Int32)l.value));
                        break;
                    case 0x1: //Int32                        
                        writer.Write((UInt32)MeteorReborn.Common.Utils.SwapEndian((UInt32)l.value));
                        break;
                    case 0x2: //Null Termed String
                    ...
                    case 0x7: //Weird one used for inventory
                        ...
                        writer.Write((UInt32)MeteorReborn.Common.Utils.SwapEndian((UInt32)type7.actorId));
                        writer.Write((Byte)type7.unknown);
                        writer.Write((Byte)type7.slot);
                        writer.Write((Byte)type7.itemPackage);
                        break;
                    case 0x9: //Two Longs (only storing first one)
                        writer.Write((UInt64)MeteorReborn.Common.Utils.SwapEndian(((Type9Param)l.value).item1));
                        writer.Write((UInt64)MeteorReborn.Common.Utils.SwapEndian(((Type9Param)l.value).item2));
                        break;
                    case 0xC: //Byte
