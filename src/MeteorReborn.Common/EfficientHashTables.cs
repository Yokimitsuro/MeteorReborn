// PM-COMPLETE → verbatim port de Common Class Lib/EfficientHashTables.cs (PM:22-179).
// LANG-ADAPT: namespace + nullable annotations en buckets[] (puede ser null per slot) y
// `default(T)` returns para tipos reference.

using System;

namespace MeteorReborn.Common.EfficientHashTables;
