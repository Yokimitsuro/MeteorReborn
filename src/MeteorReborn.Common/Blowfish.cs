...
// PM-COMPLETE → verbatim port de Common Class Lib/Blowfish.cs (PM:22-476).
// LANG-ADAPT: namespace Meteor.Common → MeteorReborn.Common. Tablas P_values / S_values
// y todo el cuerpo copiados byte por byte.
