...
:::note[Source]
This page is mirrored from the [FFXIV Classic Wiki](http://ffxivclassic.fragmenterworks.com/wiki/index.php/ZiPatch_File_Structure). Original authors retain credit; reproduced here because the upstream wiki is intermittently offline.
:::
...
- [Log in](20251119232542/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=Special:UserLogin&returnto=ZiPatch+File+Structure) 
    

#### Namespaces

  
- [Page](/MeteorReborn/reference/zipatch/) 
- [Discussion](20251119232542/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=Talk:ZiPatch_File_Structure&action=edit&redlink=1) 
...
- [Read](/MeteorReborn/reference/zipatch/) 
- [View source](20251119232542/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=ZiPatch_File_Structure&action=edit) 
- [View history](20251119232542/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=ZiPatch_File_Structure&action=history) 
...
- [Help](20251119232542/https://www.mediawiki.org/wiki/Special:MyLanguage/Help:Contents) 
    

#### Tools

   
- [What links here](http://ffxivclassic.fragmenterworks.com/wiki/index.php/Special:WhatLinksHere/ZiPatch_File_Structure)
- [Related changes](http://ffxivclassic.fragmenterworks.com/wiki/index.php/Special:RecentChangesLinked/ZiPatch_File_Structure)
- [Special pages](http://ffxivclassic.fragmenterworks.com/wiki/index.php/Special:SpecialPages)
- [Printable version](20251119232542/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=ZiPatch_File_Structure&printable=yes)
- [Permanent link](20251119232542/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=ZiPatch_File_Structure&oldid=847)
- [Page information](20251119232542/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=ZiPatch_File_Structure&action=info) 
       
-  This page was last edited on 8 June 2019, at 19:17. 
...
- [Disclaimers](http://ffxivclassic.fragmenterworks.com/wiki/index.php/FFXIV_Classic_Wiki:General_disclaimer) 
    (window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgPageParseReport":{"limitreport":{"cputime":"0.012","walltime":"0.015","ppvisitednodes":{"value":129,"limit":1000000},"ppgeneratednodes":{"value":262,"limit":1000000},"postexpandincludesize":{"value":0,"limit":2097152},"templateargumentsize":{"value":0,"limit":2097152},"expansiondepth":{"value":2,"limit":40},"expensivefunctioncount":{"value":0,"limit":100},"timingprofile":["100.00% 0.000 1 -total"]},"cachereport":{"timestamp":"20251119165345","ttl":86400,"transientcontent":false}}});});(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgBackendResponseTime":129});});
