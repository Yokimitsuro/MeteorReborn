...
:::note[Source]
This page is mirrored from the [FFXIV Classic Wiki](http://ffxivclassic.fragmenterworks.com/wiki/index.php/Monster_Models). Original authors retain credit; reproduced here because the upstream wiki is intermittently offline.
:::
...
- [Log in](20231222212122/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=Special:UserLogin&returnto=Monster+Models) 
    

#### Namespaces

  
- [Page](/MeteorReborn/world/monster-models/) 
- [Discussion](http://ffxivclassic.fragmenterworks.com/wiki/index.php/Talk:Monster_Models) 
...
- [Read](/MeteorReborn/world/monster-models/) 
- [View source](20231222212122/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=Monster_Models&action=edit) 
- [View history](20231222212122/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=Monster_Models&action=history) 
...
- [What links here](http://ffxivclassic.fragmenterworks.com/wiki/index.php/Special:WhatLinksHere/Monster_Models)
- [Related changes](http://ffxivclassic.fragmenterworks.com/wiki/index.php/Special:RecentChangesLinked/Monster_Models)
- [Special pages](http://ffxivclassic.fragmenterworks.com/wiki/index.php/Special:SpecialPages)
- [Printable version](20231222212122/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=Monster_Models&printable=yes)
- [Permanent link](20231222212122/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=Monster_Models&oldid=848)
- [Page information](20231222212122/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=Monster_Models&action=info) 
       
-  This page was last edited on 9 June 2019, at 19:04. 
...
- [Disclaimers](http://ffxivclassic.fragmenterworks.com/wiki/index.php/FFXIV_Classic_Wiki:General_disclaimer) 
    (window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgPageParseReport":{"limitreport":{"cputime":"0.041","walltime":"0.047","ppvisitednodes":{"value":1,"limit":1000000},"ppgeneratednodes":{"value":4,"limit":1000000},"postexpandincludesize":{"value":0,"limit":2097152},"templateargumentsize":{"value":0,"limit":2097152},"expansiondepth":{"value":1,"limit":40},"expensivefunctioncount":{"value":0,"limit":100},"timingprofile":["100.00% 0.000 1 -total"]},"cachereport":{"timestamp":"20231221222038","ttl":86400,"transientcontent":false}}});});(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgBackendResponseTime":66});});
