...
:::note[Source]
This page is mirrored from the [FFXIV Classic Wiki](http://ffxivclassic.fragmenterworks.com/wiki/index.php/Setting_up_the_project). Original authors retain credit; reproduced here because the upstream wiki is intermittently offline.
:::
...
-  **<SQL database>\ffxiv_server\servers**
 4. Compile the server (See [#Compiling](#Compiling))  **Note:** If you had compiled it before this, use **Rebuild Solution** instead of **Build Solution** to confirm that all the data files are copied properly 
...
- [Log in](20250716233815/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=Special:UserLogin&returnto=Setting+up+the+project) 
    

#### Namespaces

  
- [Page](/MeteorReborn/project/build/) 
- [Discussion](20250716233815/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=Talk:Setting_up_the_project&action=edit&redlink=1) 
...
- [Read](/MeteorReborn/project/build/) 
- [View source](20250716233815/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=Setting_up_the_project&action=edit) 
- [View history](20250716233815/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=Setting_up_the_project&action=history) 
...
- [Help](20250716233815/https://www.mediawiki.org/wiki/Special:MyLanguage/Help:Contents) 
    

#### Tools

   
- [What links here](http://ffxivclassic.fragmenterworks.com/wiki/index.php/Special:WhatLinksHere/Setting_up_the_project)
- [Related changes](http://ffxivclassic.fragmenterworks.com/wiki/index.php/Special:RecentChangesLinked/Setting_up_the_project)
- [Special pages](http://ffxivclassic.fragmenterworks.com/wiki/index.php/Special:SpecialPages)
- [Printable version](20250716233815/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=Setting_up_the_project&printable=yes)
- [Permanent link](20250716233815/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=Setting_up_the_project&oldid=1186)
- [Page information](20250716233815/http://ffxivclassic.fragmenterworks.com/wiki/index.php?title=Setting_up_the_project&action=info) 
       
-  This page was last edited on 18 June 2020, at 13:46. 
...
- [Disclaimers](http://ffxivclassic.fragmenterworks.com/wiki/index.php/FFXIV_Classic_Wiki:General_disclaimer) 
    (window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgPageParseReport":{"limitreport":{"cputime":"0.029","walltime":"0.031","ppvisitednodes":{"value":191,"limit":1000000},"ppgeneratednodes":{"value":283,"limit":1000000},"postexpandincludesize":{"value":155,"limit":2097152},"templateargumentsize":{"value":0,"limit":2097152},"expansiondepth":{"value":2,"limit":40},"expensivefunctioncount":{"value":0,"limit":100},"timingprofile":["100.00% 2.243 1 -total"," 74.32% 1.667 5 Template:Clear"]},"cachereport":{"timestamp":"20250716045726","ttl":86400,"transientcontent":false}}});});(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgBackendResponseTime":101});});
